        ...
        <DnDContextMenu posX={customContext.posX} posY={customContext.posY}>
          <MenuItem
            ...
            onClick={(e) => {
              ...
              openPopup(
                12,
                { p: players, n: npcsOnMap, mapId: currentMap.id },
                async (data) => {
            ...
            onClick={(e) => {
              ...
              openPopup(
                12,
                {
                  ...
                  n: npcsOnMap.filter(
                    (value) => !fighterIDs.includes(value.id)
                  ),
                  mapId: currentMap.id,
                },
                async (data) => {
              ...
              openPopup(14, {}, async (data) => {
                ...
                if (selectedPlayer.length > 0) {
                  for (let p of selectedPlayer) {
                    ...
                    data.hp = parseInt(data.hp) + parseInt(data.change) + "";
              ...
              onClick={(e) => {
                ...
                openPopup(
                  ...
                  async (data) => {
                    ...
                    let event = { name: data.name, startTime: data.time };
                    await saveFight(game, currentMap.id, {
                      ...currentFight,
