 ...
 *
 * @permission USER
 * @returns Deletes a existing Character
 */
export default async function handler(
	...
	await rm("./upload/characters/" + id + ".jpg", (err) => err);
	await rm("./upload/characters/" + id + ".png", (err) => err);
	await rm("./upload/characters/" + id + ".jpeg", (err) => err);
